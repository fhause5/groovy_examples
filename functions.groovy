...
class Deploy {
    ...
    def checkImageExists(context, object) {
        ...
        // check image tag in image stream
        ...
        return true
        println("Here is checkImageExists ${imageExists}")
    }
    ...
    def getNumericVersion(context, codebase) {
        ...
        println("Here is getNumericVersion_hash: $hash}")
        println("Here is getNumericVersion_tags: $tags}")
    }
    ...
    def deployCodebaseTemplate(context, codebase, deployTemplatesPath) {
        ...
        println("Here is image name: ${imageName}")
        script.sh("oc -n ${context.job.deployProject} process -f ${deployTemplatesPath}/${templateName}.yaml " +
    ...
    println("Here is deployCodebase ${deployCodebase}")
    ...
    void run(context) {
        script.openshift.withCluster() {
            ...
            getNumericVersion
            println("here is: ${getNumericVersion}")
